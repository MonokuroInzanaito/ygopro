...
bool Game::Initialize() {
	...
	device->setWindowCaption(L"YGOPro 777");
	...
	//main menu
	wchar_t strbuf[256];
	myswprintf(strbuf, L"YGOPro 777 Version:%X.%X.%X", PRO_VERSION >> 12, (PRO_VERSION >> 4) & 0xff, PRO_VERSION & 0xf);
...
#endif
		if(cur_time >= 1000) {
			myswprintf(cap, L"YGOPro 777 FPS: %d", fps);
